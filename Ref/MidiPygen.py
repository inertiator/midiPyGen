import Utilities.GrandStaffFunctions as gsf
import Utilities.BasicFunctions as bf
from MidiFile import MidiFile

class MidiPygen(object):
    ...
    def __init__(self, MidiFile):
        ...
        for octaves in note_octaves:
            for letters in note_letters:
                self.grand_staff[str(letters)+str(octaves)] = stf_ctr
                stf_ctr += 1
                if stf_ctr >= 128:
                    break
    ...
    def create_diatonic_map(grand_staff,LowestTonic,Chromatics):
        ...
        while NoteValue < 128:
            ...
            DiatonicScale = []
            OctCtr += 1
        return DiatonicList, OctaveList, 
